...
def parse_args():
    ...
    parser.add_argument("--data_path", default = './out/IR_drop/decap', type=str, help = 'path to the dataset')
    parser.add_argument("--save_path", default = './images/IR_drop/', type=str, help = 'path to save')
